...
export type StringComparator =
  ...
  | "string_starts_with"
  | "string_ends_with"
export type EnumSingleComparator = "enum_is" | "enum_is_not"
export type EnumMultipleComparator = "enum_contains" | "enum_does_not_contain"
export type CheckboxSpecificComparator = "checkbox_is" | "checkbox_is_not"
...
export type TitleComparator = EmptinessComparator | StringComparator
export type TextComparator = EmptinessComparator | StringComparator
export type NumberComparator = EmptinessComparator | NumberSpecificComparator
export type SelectComparator = EmptinessComparator | EnumSingleComparator
export type MultiSelectComparator = EmptinessComparator | EnumMultipleComparator
export type DateComparator = EmptinessComparator | DateSpecificComparator
export type PersonComparator = EmptinessComparator | EnumMultipleComparator
export type FileComparator = EmptinessComparator
export type CheckboxComparator = CheckboxSpecificComparator
export type URLComparator = EmptinessComparator | StringComparator
export type EmailComparator = EmptinessComparator | StringComparator
export type PhoneComparator = EmptinessComparator | StringComparator
export type CreatedEditedTimeComparator = DateComparator
export type CreatedEditedByComparator = SelectComparator
